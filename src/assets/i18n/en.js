...
module.exports = {
  ...
  satisfaction: {
    ...
    '规则内容': `
      ...
      4.To participate in this Task, Eligible Customers are required to download and log into MyLink.<br/> <br/>
      5.During the Task Period, Eligible Customers will receive 500 MyLink Points immediately after successful submission of the Task via MyLink Point zone. <br/> <br/>
      6.Eligible Customers can enter "MyLink Points"”My Points” of MyLink to view the redeemed MyLink Points.<br/> <br/>
      7.Each Eligible Customer may only participate the Task once during the Task Period. <br/> <br/>
      8.MyLink Points can only be used via MyLink to the exclusion of other CMHK channels.<br/> <br/>
      9.MyLink Points shall be invalid after the expiry date as shown on ”My Points” of MyLink. Expired MyLink Points will not be reissued.<br/> <br/>
      10.Points cannot be exchanged for cash, or sold, purchased, assigned or transferred to others.<br/> <br/>
      11.Entitlement to the MyLink Points and eligibility of customers to participate in this Task shall be determined by CMHK at its sole discretion. <br/> <br/>
      12.CMHK reserves the right to disqualify any customer from participating in this Task, forfeit his/her entitlement to MyLink Points, cancel the relevant transaction and/or take legal actions against the relevant customer should there be any violation of these Terms and Conditions or illegal, fraudulent or abusive behavior during the participation of this Task.<br/> <br/>
      13.CMHK shall not be responsible for any matters arising from or in connection with the delay, loss, transmission error of or inability to recognize any information submitted by Eligible Customers due to technical problems, including but not limited to any computer or internet network problems. <br/> <br/>
      ...
      15.Each Eligible Customer participating in this Task is deemed to have read and agreed to these Terms and Conditions.<br/> <br/>
      16.In case of any dispute regarding any matter of this Task, CMHK reserves the right to make any final decisions.<br/> <br/>
  ...
  preference: {
    ...
    '规则内容': `
      ...
      3.This Task is applicable to MyLink customers (“Eligible Customers”) .<br/> <br/>
      4.To participate in this Task, Eligible Customers are required to download and log into MyLink.<br/> <br/>
      5.During the Task Period, Eligible Customers will receive 200 MyLink Points immediately after successful submission of the Task via MyLink Point zone. <br/> <br/>
      6.Eligible Customers can enter "MyLink Points"”My Points” of MyLink to view the redeemed MyLink Points.<br/> <br/>
      7.Each Eligible Customer may only participate the Task once during the Task Period. <br/> <br/>
      8.MyLink Points can only be used via MyLink to the exclusion of other CMHK channels.<br/> <br/>
      9.MyLink Points shall be invalid after the expiry date as shown on ”My Points” of MyLink. Expired MyLink Points will not be reissued.<br/> <br/>
      ...
      12.CMHK reserves the right to disqualify any customer from participating in this Task, forfeit his/her entitlement to MyLink Points, cancel the relevant transaction and/or take legal actions against the relevant customer should there be any violation of these Terms and Conditions or illegal, fraudulent or abusive behavior during the participation of this Task.<br/> <br/>
      13.CMHK shall not be responsible for any matters arising from or in connection with the delay, loss, transmission error of or inability to recognize any information submitted by Eligible Customers due to technical problems, including but not limited to any computer or internet network problems. <br/> <br/>
      14.CMHK reserves the right to alter any contents of this Task, terminate this Task, and/or change, amend or modify these Terms and Conditions at any time without prior notice.<br/> <br/>
      15.Each Eligible Customer participating in this Task is deemed to have read and agreed to these Terms and Conditions.<br/> <br/>
      16.In case of any dispute regarding any matter of this Task, CMHK reserves the right to make any final decisions.<br/> <br/>
      17.Should there be any discrepancy between the English and Chinese versions of these Terms and Conditions, the English version shall apply and prevail.
    `
